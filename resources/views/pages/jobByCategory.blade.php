                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-12">
                                        <div style="margin-left: 12px">
                                            <a href="{{ route('singleJob',['id'=>$jobByCategories->id, 'company_id'=>$jobByCategories->company->id]) }}"><img src="{{ asset($jobByCategories->company->logo) }} " alt="" style=" width: 80px; height: 75px " ></a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="bs-component">
                                            <div class="list-group">
                                                ...
                                                <button class="btn btn-primary pull-right" style="margin-top: -20px">
                                                    <a href="{{ route('singleJob',['id'=>$jobByCategories->id, 'company_id'=>$jobByCategories->company->id]) }}" style="color: #f0f0f0">View now</a>
                                                </button>
                                                <a href="#" >
