<div class="step2">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            <textarea name="jobDescription" id="" cols="15" rows="8" class="form-control" required></textarea>
        </div>

        <div class="col-md-12">
            <label for="exampleInputEmail1">Job Requirement</label>
            <textarea name="jobRequirement" id="" cols="15" rows="8" class="form-control" required></textarea>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="exampleInputEmail1">Number of hire</label>
